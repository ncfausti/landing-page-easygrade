...
export default function LandingEmail() {
  ...
  return (
    <>
      ...
      ></input>
      <button
        className="inline-flex h-12 items-center justify-center rounded-md border-2 border-black bg-amber-300 px-8 text-sm font-extrabold shadow-sm transition-colors hover:bg-amber-400  focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:bg-gray-950 dark:hover:bg-gray-800 dark:hover:text-gray-50 dark:focus-visible:ring-gray-300"
